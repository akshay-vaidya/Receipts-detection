...
alexnet.load_weights('receipts_512')
img = pil_image.open(sys.argv[1])
img=img.resize((512,512),pil_image.ANTIALIAS)
img = img_to_array(img)
img = np.expand_dims(img, axis=0)
pred = alexnet.predict(img)
labels=['not a receipt', 'receipt']
print labels
print pred
